---
curso: CONTAGER
titulo: Presupuesto estatico(esperado) y flexible (real)
slides: 0
fuente: Presupuesto estatico(esperado) y flexible (real).xlsx
---

<!-- INTERPRETAR-POR-COMPOSER: este capítulo es PLACEHOLDER. Reescribí el cuerpo
     (qué es, qué enseña, para qué sirve en un proyecto real) en 150-250 palabras
     y dejá el bloque de código/data/tabla AL FINAL (trazabilidad). Fuente: Presupuesto estatico(esperado) y flexible (real).xlsx. -->

<!-- INTERPRETAR: datos tabulares de Presupuesto estatico(esperado) y flexible (real).xlsx. El capítulo debe ser una
