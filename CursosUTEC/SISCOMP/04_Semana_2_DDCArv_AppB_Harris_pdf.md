---
curso: SISCOMP
titulo: 04 - Semana 2/DDCArv_AppB_Harris
slides: 4
fuente: 04 - Semana 2/DDCArv_AppB_Harris.pdf
---
...
0000011 (3)         000    –                 I       lb        rd,         load byte
                                                                      imm(rs1)                                     rd =   SignExt([Address]7:0)
...
1010011 (83)      001       11100, fmt      00000 R            fclass rd,fs1                      classify                            rd = classification of fs1
                                                                                 RVF only
0000111 (7)       010       –               –         I        flw       fd, imm(rs1) load float                                      fd = [Address]31:0
...
1010011 (83)      000       1111000         00000     R        fmv.w.x   fd, rs1      move to f.p. register                           fd = rs1
                                                                                 RVD only
0000111 (7)       011       –               –         I        fld       fd, imm(rs1) load double                                     fd = [Address]63:0
