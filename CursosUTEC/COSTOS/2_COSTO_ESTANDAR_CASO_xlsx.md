---
curso: COSTOS
titulo: 2. COSTO ESTANDAR CASO
slides: 0
fuente: 2. COSTO ESTANDAR CASO.xlsx
---

<!-- INTERPRETAR-POR-COMPOSER: este capítulo es PLACEHOLDER. Reescribí el cuerpo
     (qué es, qué enseña, para qué sirve en un proyecto real) en 150-250 palabras
     y dejá el bloque de código/data/tabla AL FINAL (trazabilidad). Fuente: 2. COSTO ESTANDAR CASO.xlsx. -->

<!-- INTERPRETAR: datos tabulares de 2. COSTO ESTANDAR CASO.xlsx. El capítulo debe ser una
